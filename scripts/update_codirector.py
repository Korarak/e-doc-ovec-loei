...
def update_codirector_sign():
    file_path = r'c:\Users\Korarak\Desktop\edoc67\codirector_sign.php'
...
"""
    ...
    if i1 != -1 and i2 != -1:
        ...
        with open(file_path, 'w', encoding='utf-8') as f:
            f.write(text)
        print("Success for codirector_sign")
    else:
        print("Markers not found for codirector_sign")

if __name__ == '__main__':
    update_codirector_sign()
    print("Done")
