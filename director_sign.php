        ...
        <div class="lg:col-span-4 space-y-6">
            ...
            <div class="bg-white rounded-2xl shadow-sm border border-gray-100 p-6">
                <form id="text-form" method="post" action="sarabun_generate_3.php" class="space-y-4">
                    ...
                    <input type="hidden" name="signer_role" value="director">
...
<script>
    ...
    document.getElementById('prev-page').addEventListener('click', function() {
        if (pageNum <= 1) return;
        pageNum--;
        window.location.href = `director_sign.php?doc_id=<?= $doc_id ?>&file_id=<?= $file_id ?>&page=${pageNum}`;
    });
